...
// CirclePay contract addresses
export const CIRCLEPAY_ADDRESSES: { [key: number]: string } = {
  84532: "0x2484A7F612B8EE8062B8f31764Cf0266b51cD0Bd", // Base Sepolia
  421614: "0x2B9c43c8372AeaB9ad9D7d704A2A0535ff76d608", // Arbitrum Sepolia
  11155420: "0x245B56cEbD3Ea34EBFabFe86421709d22FE81615", // Optimism Sepolia
  5: "0xf881FB674887889616306480E70391a4C97CcC94", // Sepolia
};
...
// Get CirclePay contract address
export const getCirclePayAddress = async (
  chainId: number
): Promise<string | undefined> => {
  return CIRCLEPAY_ADDRESSES[chainId];
};

export const ETHERSCAN_URLS: { [key: number]: string } = {
  1: "https://etherscan.io",
  5: "https://sepolia.etherscan.io",
